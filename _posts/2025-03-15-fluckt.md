...
categories: []
author: ''
post_image: "/assets/images/posts/fluctt.png"
post_format: ''
trending: true
...
The link is [here](https://pykt-toolkit.readthedocs.io/en/latest/models.html#fluctt) and the API is [here](https://pykt-toolkit.readthedocs.io/en/latest/pykt.models.html#module-pykt.models.fluckt).
